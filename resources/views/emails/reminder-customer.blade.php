	...
	<head>
		...
		<title>[Reminder Job Email]-MobileMuslim</title>
		<style type="text/css">
			/* RESET STYLES */
						...
						<table bgcolor="#FFFFFF"  border="0" cellpadding="0" cellspacing="0" width="500" id="emailBody">
							...
							<tr>
								<td align="center" valign="top">
									...
									-->
									<table border="0" cellpadding="0" cellspacing="0" width="100%" style="color:#FFFFFF;" bgcolor="#2E8B57">
										<tr>
											<td align="center" valign="top">
												<!-- FLEXIBLE CONTAINER // -->
												<!--
															...
															<table border="0" cellpadding="30" cellspacing="0" width="100%">
																<tr>
																	<td align="center" valign="top" class="textContent">
																		<h1 style="color:#FFFFFF;line-height:100%;font-family:Helvetica,Arial,sans-serif;font-size:35px;font-weight:normal;margin-bottom:5px;text-align:center;">Reminder Notifications</h1>
																		<h2 style="text-align:center;font-weight:normal;font-family:Helvetica,Arial,sans-serif;font-size:23px;margin-bottom:10px;color:#FFFFFF;line-height:135%;">to perform job</h2>
																		<div style="text-align:center;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;color:#FFFFFF;line-height:135%;">Mobile Muslim is a platform built to make it easier for Muslim consumers to find Muslim service providers</div>
																	</td>
																</tr>
															</table>
															<!-- // CONTENT TABLE -->
																		...
																		<table border="0" cellpadding="0" cellspacing="0" width="100%">
																			<tr>
																				<td valign="top" class="textContent">
																					...
																					-->
																					<h3 mc:edit="header" style="color:#5F5F5F;line-height:125%;font-family:Helvetica,Arial,sans-serif;font-size:20px;font-weight:normal;margin-top:0;margin-bottom:3px;text-align:left;">Assalamualaikum, {{$cust_name}}</h3>
																					<div mc:edit="body" style="text-align:left;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;color:#5F5F5F;line-height:135%;">Dear valueable customer, you are receiving this email because we want to notify you on upcoming job based on booking details below:</div>
                               												<br>
                               												<br>
                               												<br>
																			<div mc:edit="body" style="text-align:left;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;color:#5F5F5F;line-height:135%;">
																			  ...
																			  Date Booking: {{date('d M Y', strtotime($date_booking))}}
																			</div>
																			<br>
																			<div>
																				Kindly check details of job in website now !
																			</div>
																																							</td>
																			</tr>
																		</table>
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                      <tr>
                                        <td valign="top" class="textContent">
                                          ...
                                          <thead>
                                          <tr>
                                            <th style="width: 25%;">Type Service</th>
                                           ...
                                           <tbody>
                                            ...
                                            @foreach($book as $key=>$data)
                                              <tr>
                                                <td align="center">{{$data->type_service}}</td>
                                                <td align="center">{{$data->name}}</td>
                                                <td align="center">{{$data->u_phone}}</td>
                                              </tr>
                                          @endforeach
                                          </tbody>
                                          </table>                                      
																		...
																		<table border="0" cellpadding="0" cellspacing="0" width="100%">
																			<tr>
																				<td valign="top" class="textContent">
																					...
																					<div mc:edit="body" style="text-align:left;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;color:#5F5F5F;line-height:135%;">Mobile Muslim Administrator</div>
																				</td>
																			</tr>
																		</table>
																		<!-- // CONTENT TABLE -->
														...
														<td valign="top" width="500" class="flexibleContainerCell">
															...
															<table align="left" border="0" cellpadding="0" cellspacing="0" width="100%">
																<tr>
																	...
																	<td align="right" valign="top" class="flexibleContainerBox" style="background-color:#2E8B57;">
																		<table class="flexibleContainerBoxNext" border="0" cellpadding="30" cellspacing="0" width="100%" style="max-width:100%;">
																			<tr>
																				<td align="left" class="textContent">
																					...
																					<div style="text-align:left;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;color:#FFFFFF;line-height:135%;">Enjoy be part of Moblie Mulsim Members</div>
																				</td>
																			</tr>
																		</table>
																	</td>
