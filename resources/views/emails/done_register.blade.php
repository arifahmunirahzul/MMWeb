	...
	<head>
		...
		<title>[Welcoming Email]-MobileMuslim</title>
		<style type="text/css">
			/* RESET STYLES */
															...
															<table border="0" cellpadding="30" cellspacing="0" width="100%">
																<tr>
																	<td align="center" valign="top" class="textContent">
																		<h1 style="color:#FFFFFF;line-height:100%;font-family:Helvetica,Arial,sans-serif;font-size:35px;font-weight:normal;margin-bottom:5px;text-align:center;">Successfully Register</h1>
																		<h2 style="text-align:center;font-weight:normal;font-family:Helvetica,Arial,sans-serif;font-size:23px;margin-bottom:10px;color:#FFFFFF;line-height:135%;">with Mobile Muslim</h2>
																		...
																		<table border="0" cellpadding="0" cellspacing="0" width="100%">
																			<tr>
																				<td valign="top" class="textContent">
																					...
																					<div mc:edit="body" style="text-align:left;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;color:#5F5F5F;line-height:135%;">You are receiving this email because you have been register as a Member in Mobile Muslim. Hope you enjoy tour service.</div>
																				</td>
																			</tr>
																		</table>
																		<!-- // CONTENT TABLE -->
