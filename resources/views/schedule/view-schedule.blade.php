                  ...
                  @endif
                   ...
                   <div class="row">
                    ...
                    <div class="col-sm-7">
                      ...
                      <div class="form-group">
                        @if($data->type_service == 'Pembantu Rumah')
                        <a href="{{route('viewTaskPembantuRumah')}}"<button class="btn btn-sm btn-danger" type="submit">Back</button></a>
                        @endif
                        @if($data->type_service == 'Urut Pantang')
                        <a href="{{route('viewTaskUrutPantang')}}"<button class="btn btn-sm btn-danger" type="submit">Back</button></a>
                        @endif
                        @if($data->type_service == 'Katering')
                        <a href="{{route('viewTaskKatering')}}"<button class="btn btn-sm btn-danger" type="submit">Back</button></a>
                        @endif
                      </div>
                @endforeach     
              </div>
