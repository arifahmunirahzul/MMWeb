          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <h4 class="card-title">Add New Booking - Katering</h4>
              </div>
              <div class="card-body">
                ...
                <div class="toolbar">
                 ...
                 {{Form::open(array('route' => 'BookKatering','method'=>'POST'))}}
                @csrf
                  <div class="row">
                    ...
                    <div class="col-md-7">
                      <div class="form-group">
                                {{Form ::text('total_visitor',null,[ 'placeholder'=>'Total Visitor','class'=>'form-control','rows'=>'6'])}}  
                       </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-7">
                      <div class="form-group">
                                <select name="type_event" class="form-control" placeholder="Please Select Event" >
  ...
  <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class ="modal-content">
         ...
         {{Form::open(array('route' => 'addUserNewKatering','method'=>'POST'))}}
          @csrf
