                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-10">
                      <div class="form-group">
                        <input type="text" class="form-control"  name="booking_id" id="booking_id" disabled="">
                      </div>
                    </div>
                  </div>
                  <div class="row">
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-10">
                      <div class="form-group">
                        <input type="text" class="form-control"  name="service" id="service" disabled="">
                      </div>
                    </div>
                  </div>
                  <div class="row">
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-10">
                      <div class="form-group">
                           <textarea name="message" id="message" class="form-control"  disabled=""></textarea>
