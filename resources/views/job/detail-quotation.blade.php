          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <h4 class="card-title">View Quotation Details</h4>
              </div>
              <div class="card-body">
                <div class="toolbar">
                </div>
                @foreach($job as $key=>$data)
                  ...
                  <br>
                   <div class="row">
                    ...
                    <div class="col-sm-7">
                      <div class="form-group">
                        {{Form ::label('price','RM'.$data->price,['class'=>'form-control','rows'=>'6' , 'required'])}}
                      </div>
                    </div>
                  </div>
                   <div class="row">
                    ...
                    <div class="col-sm-7">
                      <div class="form-group">
                        {{Form ::label('status',$data->status,['class'=>'form-control','rows'=>'6' , 'required'])}}
                      </div>
                    </div>
                  </div>
                @endforeach
                      ...
                      <br>
                      <div class="form-group">
                        <a href="{{route('viewStatusQuotation')}}"<button class="btn btn-sm btn-danger" type="submit">Back</button></a>
                      </div>
